...
TOP BRANDS WITH EVERY RECHARGE</pre></h3></div>
                   <div id="pic-2">
                      <form action="login.php" method="post">
                          <table style="width:80%" border="0">
                              <tr>
                             <td><input style="height: 50px; border:2px solid grey;font-family: Calibri;text-align:center" type="text" placeholder="Enter Your Mobile Number"  size="50" maxlength="50" required></td>
                            <td><select style="height: 50px; border:2px solid grey;font-family: Calibri;text-align:center"  >
                                <option></option>
                                ...
                                <option>RELIANCE</option>
                                   ...
                                   <td><input style=" width:100%;height:50px; color:#fff;background-color:#000;border:1px solid black" type="submit" value="RECHARGE"></td>
                              </tr>
                          </table>
				...
				magni dolores eos qui ratione.</p></div>
                     ...
                     <div id="sro-4">
                     <h2 style="text-align:center;color:#000;margin-top:20px">SIGN UP</h2>
                         <form style="text-align:center" action="login.php" method="post">
                           ...
                           <br>
                             ...
                             <br>
                             <br>
                             <input style="height:20px;text-align:center;border:1px solid grey;" type="text" id="username" name="username" placeholder="enter Your username"  size="50" maxlength="50" required>
